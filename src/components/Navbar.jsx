...
const Navbar = () => {
  const [navHeight, setNavHeight] = useState("106px");
  const [navTop, setNavTop] = useState("106px");
  ...
  return (
    ...
    onMouseLeave={() => setShowServices(false)}>
      <div className="nav w-full px-8 flex items-center justify-between"  style={{ height: navHeight }}>
        ...
        <div className="flex items-center gap-12">
          <div className="flex items-center gap-12">
            <a
              href=""
              className="text-xl font-sans link services"
              onMouseEnter={() => setShowServices(true)}
            >
              Services
            </a>
            <a href="" className="text-xl font-sans link">
              Work
            </a>
            <a href="" className="text-xl font-sans link">
              About
          ...
          <div className="px-[20px] button py-[12px] flex items-center gap-[12px] text-[16px] font-sans font-medium cursor-pointer text-[#0f0f0f] transition-all leading-none rounded-[500px] border-[1.5px] border-[#B0B0B0]">
            Contact us
            <svg
              class="w-5 fill-current | md:w-6 lg:w-8"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 30 15"
            >
      ...
      <div
        className={`serviceSection z-20 transition-all absolute bg-white w-full duration-700 border-t-[#B4B4B4] border-t-[1.5px] px-[160px] py-[40px] flex servicesection items-center gap-[0px] divshadow service-section ${
          showServices ? "flex opacity-100" : "animateService"
        }`}
        style={{ top: navTop}}
      >
        <div className="w-[500px] px-[16px] pb-[16px] flex flex-col items-center text-center gap-[16px]">
          <p className="text-[24px] font-extralight font-serif link cursor-pointer link1 text-[#262626]">
            Digital Strategy
          </p>
          <p className="text-[24px] font-extralight font-serif link cursor-pointer link1 text-[#262626]">
            Paid Search
