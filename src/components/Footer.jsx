...
const Footer = () => {
  return (
    ...
    <div className="relative pt-[280px]">
      <div className="p-[105px] absolute top-0 mx-80 w-[calc(100%-640px)] min-h-96">
        <div className="flex flex-col items-center justify-center ml-[40px] text-center gap-6 z-[100] absolute top-[53%]  translate-y-[-50%]">
          <h1 className='text-[30px] font-medium text-center items-center Cooper text-white'>Call <span className='relative'><svg className="absolute bottom-[-4px] z-[-1] h-[16px] w-[100%] left-0" viewBox="0 0 271 19" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" > <path     d="M268.783 18.599C123.253-1.529 2.459 13.367 1.262 13.521L.053 6.061c1.22-.155 123.176-15.227 270.02 5.089l-1.29 7.449z"     fill="#00EB8F" /> </svg> Demie</span> on +44(0)161 509 0777 or email demie@thisisdigital.co.uk to <br /> discuss how we can help you.</h1>
          <div className="flex items-center gap-[24px]">
            <div className="flex items-center gap-[12px] my-[8px]"><img src="/images/profile.webp" className='w-[48px] h-[48px] rounded-[500px] bg-[#DBEAFE]' alt="" /><p className='text-[23px] font-sans text-[#fff]'>Sound good?</p></div>
            <div className="px-[20px] button py-[12px] flex items-center gap-[12px] text-[16px] font-sans font-medium cursor-pointer text-[#fff] transition-all leading-none rounded-[500px] border-[1.5px] border-[#B0B0B0]">Request a callback<svg class="w-5 fill-current | md:w-6 lg:w-8"  fill="none"  xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 30 15">  <path d="M29.565 7.029l-7.026 7.027-.79-.798 5.621-5.626a8.771 8.771 0 01-.014-.048c-.697-.002-1.394 0-2.091-.001H0V6.477h27.35l.022-.041-5.63-5.63.79-.806 7.033 7.029z"></path></svg></div>
        </div>
        </div>
        <div className="absolute top-0 left-0 bg-cover bg-image w-full h-full z-[0]"></div>
      </div>
      <div className="pt-28 px-80 flex flex-col gap-0 bg-black">
          <div className="py-16 flex gap-36">
            <div className="flex flex-col gap-6 min-w-80">
              <h1 className='text-[53px] font-medium Cooper text-white'>Become our <br />  <span className='Cooper relative'>partner  <img src="/images/circle-green.svg" className='absolute select-none min-w-[200px] h-[90px] top-[-11px] left-[-12px]' alt="" draggable="false" /></span>  today</h1>
              <div className="flex items-center button-div gap-[12px]">
                <p className="text-[25px] text-[#fff] font-sans">Let's talk</p>
